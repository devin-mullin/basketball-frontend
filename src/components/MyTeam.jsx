...
function MyTeam({ user, setSelectedTeam, selectedTeam }) {
  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://nameless-ravine-11360.herokuapp.com/user_teams", {
      ...
      .then(() => {
        ...
        alert(
          `say hello to ${teamName}, the hottest new upstarts in the league`
        );
        navigate("/");
        navigate("/my-team");
      })
  ...
  return (
    <div className="team">
      ...
      ></Select>
      {selectedTeam !== "" ? (
        <MyTeamDetail user={user} teamId={selectedTeam.id} />
      ) : null}
      ...
      >
        ...
        <br />
        <Button type="submit" className="myteam-button" onClick={handleSubmit}>
          submit
        </Button>
      </Form>
    </div>
